...
const DisplayBooking = () => {
  ...
  const fetchBookings = () => {
    try {
      ...
      axios
        .get(`http://localhost:3001/bookings/getbookings/${uid}`)
        .then((res) => {
  ...
  const handleDelete = (bookingId) => {
    ...
    axios
      .post(`http://localhost:3001/bookings/deletebooking/${bookingId}`)
      .then((res) => {
        ...
        <div className="booking-list">
          {bookings.map((booking, index) => (
            <div key={index} className="booking-card">
              <img
                src={booking.room_img_src}
                alt={`Room at ${booking.hotel_name}`}
              ...
              <div className="booking-card-content">
                ...
                <p>
                  <strong>Check-in Date:</strong> {booking.checkin_date}
                </p>
                <p>
                  <strong>Check-out Date:</strong> {booking.checkout_date}
                </p>
                <p>
